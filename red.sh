...
Exp1=$(curl -sS https://raw.githubusercontent.com/QuinStore/vip/main/ip | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/QuinStore/vip/main/ip | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
else
...
wget -q -O https://raw.githubusercontent.com/QuinStore/vip/main/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
clear
clear
...
sleep 2
clear
curl "https://raw.githubusercontent.com/QuinStore/vip/main/menu/ssh-vpn.sh" | bash
sleep 2
wget https://raw.githubusercontent.com/QuinStore/vip/main/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
wget -q -O demeling.sh https://raw.githubusercontent.com/QuinStore/vip/main/demeling.sh && chmod +x demeling.sh && ./demeling.sh
cd
mkdir -p /root/udp
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
...
sleep 2
clear
curl "https://raw.githubusercontent.com/QuinStore/vip/main/Insshws/insshws.sh" | bash
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/QuinStore/vip/main/menu/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/QuinStore/vip/main/Finaleuy/notramcpu" && chmod +x /usr/bin/notramcpu
cd
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
curl "https://raw.githubusercontent.com/QuinStore/vip/main/menu/insray.sh" | bash
sleep 1
curl "https://raw.githubusercontent.com/QuinStore/vip/main/arca.sh" | bash
sleep 1
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install slowdns               $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -q -O slowdns.sh https://raw.githubusercontent.com/QuinStore/vip/main/SLDNS/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
mkdir /root/akun
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 1
curl "https://raw.githubusercontent.com/QuinStore/vip/main/ipsec/ipsec.sh" | bash
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install OPENVPN             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
wget "https://raw.githubusercontent.com/QuinStore/vip/main/Insshws/vpn.sh" && bash vpn.sh && rm vpn.sh
clear
echo "Installing Bot Panel" | lolcat
echo "Siapkan Token bot dan ID telegram mu"
rm -rf bot.sh && wget https://raw.githubusercontent.com/QuinStore/vip/main/botssh/bot.sh && chmod 777 bot.sh && ./bot.sh && systemctl restart cybervpn
USERID=6993894531
KEY="7274636166:AAG2UcLRqSJ0fZMZEHlez0hevM1RovqCYoY"
TIMEOUT="10"
