...
# status
rm -rf /root/status
wget -q -O /root/status "https://raw.githubusercontent.com/QuinStore/vip/main/statushariini" 

today=`date -d "0 days" +"%Y-%m-%d"`
Exp2=$(curl -sS https://raw.githubusercontent.com/QuinStore/vip/main/ip | grep $MYIP | awk '{print $3}')
...
#update
wget -q -O updatsc.sh "https://raw.githubusercontent.com/QuinStore/vip/main/menu/updateyes.sh" && chmod +x updatsc.sh && ./updatsc.sh 

# // Exporting IP Address
export MYIP=$( curl -s https://ipinfo.io/ip/ )
Name=$(curl -sS https://raw.githubusercontent.com/QuinStore/vip/main/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/QuinStore/vip/main/ip | grep $MYIP | awk '{print $3}')
...
echo -e "${GREEN}| \E[44;1;39m    °DIDA STORE SCRIPT°        \E[0m|"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
...
echo -e "${GREEN}│ ${BOLD}${LIGHT}Developer = DIDA STORE PREMIUIM💯                         ${NC}"
